...
#backpropagation
    ...
    #output layer       
        ...
        deltas = Network.Sigmoid(output[0][-1],True)\
        *(output[1][-1]-des_out[:])
    ...
    #hidden layers                     
        ...
        for l in range(2,len(self.N)):
            ...
            sumation = np.full((self.N[-(l-1)],self.N[-l]),Network.ReLU(output[0][-l][:],True)).T\
...
#learning algorithm with optional learning rate, cost treshold and GD methods
    ...
    #main training loop        
        ...
        print(f'Training successful. Parameters saved to: \
